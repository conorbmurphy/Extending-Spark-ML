...
//def parse(i: String): Tuple = {
//  val result = Tuple[String]
//  JSON.parseFull(i) match {
//    case Some(m: Map[String, Any]) => m("text") match {
//      case s: String => s
//    }
//  }
//}
...
//def findVal(ToFind: String): String = {
//  JSON.parseFull(x) match {
//    case Some(m: Map[String, Any]) => m(ToFind) match {
//      case s: String => s
//    }
//  }
//}
